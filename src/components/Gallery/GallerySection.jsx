...
const GallerySection = () => {
  ...
  return (
    <div className="mx-5 md:mx-10 lg:mx-20 pt-32">
      <h1 className="text-center text-3xl md:text-lg text-purple-600 lg:text-left my-4">
        Gallery
      </h1>
      <div className="flex flex-col gap-2 md:gap-10 justify-between lg:flex-row lg:gap-20 w-[100%] md:mt-10">
        <h1 className="text-xl text-center md:text-4xl lg:text-left  lg:text-5xl">
